  ...
  return (
    <aside className="sticky top-20 flex flex-col gap-0 border border-hairline bg-surface lg:min-w-[320px]">
      ...
      <div className="flex flex-col gap-4 px-6 py-5">
        ...
        {/* Promo input. */}
        <div>
          <p className="mb-2 font-display text-[9px] font-semibold uppercase tracking-widest text-secondary">
            Access Code / Promo
          </p>
          <div className="flex gap-0">
            ...
            <button
              ...
              className="border border-l-0 border-hairline bg-elevated px-4 font-display text-[10px] font-semibold uppercase tracking-widest text-primary transition-colors hover:border-acid hover:text-acid disabled:opacity-40"
            >
              {applying ? '…' : 'Apply'}
            </button>
          </div>
