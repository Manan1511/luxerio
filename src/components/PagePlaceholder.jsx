...
export default function PagePlaceholder({ title, phase, blurb }) {
  return (
    <section className="mx-auto max-w-[1280px] px-6 py-24 lg:px-16">
      <span className="inline-block bg-primary px-2 py-1 font-display text-[10px] font-bold uppercase tracking-widest text-base">
        {phase} — placeholder
      </span>
      <h1 className="mt-6 font-display text-6xl font-semibold uppercase leading-none tracking-tight text-primary md:text-8xl">
        {title}
      </h1>
